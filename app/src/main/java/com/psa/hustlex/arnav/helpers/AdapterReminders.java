...
public class AdapterReminders extends RecyclerView.Adapter<AdapterReminders.MyViewHolder> {
    ...
    private final HeapPriorityQueue<Reminders> reminderQueue;
    ...
    public AdapterReminders(HeapPriorityQueue<Reminders> reminderQueue, OnDeleteClickListener onDeleteClickListener, OnUpdateClickListener onUpdateClickListener) {
